...
class QCE_EXPORT QEditorFactory : public Q_EDITOR_FACTORY_BASE,
...
public:
    ...
    QCodeEdit *editor(const QString &file, QLanguageDefinition *l,
                      QFormatScheme *s = 0, QCodeCompletionEngine *e = 0,
                      const QString &layout = QString()) const;
