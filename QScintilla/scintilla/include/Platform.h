...
public:
    ...
    ColourAlpha(unsigned int red, unsigned int green,
                unsigned int blue) noexcept
...
struct FontParameters {
    ...
    FontParameters(const char *faceName_, float size_ = 10, int weight_ = 400,
        ...
        :
          ...
          faceName(faceName_), size(size_), weight(weight_), italic(italic_),
          extraFontFlag(extraFontFlag_), technology(technology_),
