...
public:
  ...
  virtual std::any visitLambdaExpression(AngelscriptConsoleParser::LambdaExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitLambdaIntroducer(AngelscriptConsoleParser::LambdaIntroducerContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitLambdaCapture(AngelscriptConsoleParser::LambdaCaptureContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitCaptureDefault(AngelscriptConsoleParser::CaptureDefaultContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitCaptureList(AngelscriptConsoleParser::CaptureListContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitCapture(AngelscriptConsoleParser::CaptureContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitSimpleCapture(AngelscriptConsoleParser::SimpleCaptureContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitInitcapture(AngelscriptConsoleParser::InitcaptureContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitLambdaDeclarator(AngelscriptConsoleParser::LambdaDeclaratorContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitNewPlacement(AngelscriptConsoleParser::NewPlacementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitNewInitializer_(AngelscriptConsoleParser::NewInitializer_Context *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitStatement(AngelscriptConsoleParser::StatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitLabeledStatement(AngelscriptConsoleParser::LabeledStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitExpressionStatement(AngelscriptConsoleParser::ExpressionStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitCompoundStatement(AngelscriptConsoleParser::CompoundStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitStatementSeq(AngelscriptConsoleParser::StatementSeqContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitSelectionStatement(AngelscriptConsoleParser::SelectionStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitCondition(AngelscriptConsoleParser::ConditionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitIterationStatement(AngelscriptConsoleParser::IterationStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitForInitStatement(AngelscriptConsoleParser::ForInitStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitForRangeDeclaration(AngelscriptConsoleParser::ForRangeDeclarationContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitForRangeInitializer(AngelscriptConsoleParser::ForRangeInitializerContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitJumpStatement(AngelscriptConsoleParser::JumpStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitDeclarationseq(AngelscriptConsoleParser::DeclarationseqContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitDeclaration(AngelscriptConsoleParser::DeclarationContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAliasDeclaration(AngelscriptConsoleParser::AliasDeclarationContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitSimpleDeclaration(AngelscriptConsoleParser::SimpleDeclarationContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitTrailingTypeSpecifierSeq(AngelscriptConsoleParser::TrailingTypeSpecifierSeqContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitBalancedTokenSeq(AngelscriptConsoleParser::BalancedTokenSeqContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitBalancedtoken(AngelscriptConsoleParser::BalancedtokenContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitDeclarator(AngelscriptConsoleParser::DeclaratorContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitDeclaratorDef(AngelscriptConsoleParser::DeclaratorDefContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitParametersAndQualifiers(AngelscriptConsoleParser::ParametersAndQualifiersContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitRefqualifier(AngelscriptConsoleParser::RefqualifierContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitDeclaratorid(AngelscriptConsoleParser::DeclaratoridContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitParameterDeclarationClause(AngelscriptConsoleParser::ParameterDeclarationClauseContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitParameterDeclarationList(AngelscriptConsoleParser::ParameterDeclarationListContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitParameterDeclaration(AngelscriptConsoleParser::ParameterDeclarationContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitTheOperator(AngelscriptConsoleParser::TheOperatorContext *ctx) override {
    return visitChildren(ctx);
  }
