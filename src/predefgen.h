...
//         marcos.insert(QLatin1String("__ANGELSCRIPT_VERSION_MAJOR__"),
//         INT_TYPE);
//         marcos.insert(QLatin1String("__ANGELSCRIPT_VERSION_MINOR__"),
//         INT_TYPE);
//         marcos.insert(QLatin1String("__ANGELSCRIPT_VERSION_PATCH__"),
//         INT_TYPE); marcos.insert(QLatin1String("__WINGHEX_APPNAME__"),
//         STRING_TYPE); marcos.insert(QLatin1String("__WINGHEX_AUTHOR__"),
//         STRING_TYPE); marcos.insert(QLatin1String("__QT_VERSION__"),
//         STRING_TYPE); marcos.insert(QLatin1String("__QT_VERSION_MAJOR__"),
//         INT_TYPE); marcos.insert(QLatin1String("__QT_VERSION_MINOR__"),
//         INT_TYPE); marcos.insert(QLatin1String("__QT_VERSION_PATCH__"),
//         INT_TYPE); marcos.insert(QLatin1String("__LANG__"), STRING_TYPE);
