...
//! \brief The QsciLexerAs class encapsulates the Scintilla AngelScript
//! lexer.
//! \note This class is modified from QsciLexerCPP
...
public:
    ...
    QsciLexerAs(QObject *parent = 0, bool caseInsensitiveKeywords = false);
