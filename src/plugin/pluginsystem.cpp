...
void PluginSystem::connectReaderInterface(IWingPlugin *plg) {
    ...
    connect(
        preader, &WingPlugin::Reader::isCurrentDocEditing, _win,
        [=]() -> bool { return pluginCurrentEditor(sender()); },
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::currentDocFilename, _win,
        [=]() -> QString {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::isLocked, _win,
        [=]() -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::isEmpty, _win,
        [=]() -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::isKeepSize, _win,
        [=]() -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::isModified, _win,
        [=]() -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::isReadOnly, _win,
        [=]() -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::documentLines, _win,
        [=]() -> qsizetype {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::documentBytes, _win,
        [=]() -> qsizetype {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::currentPos, _win,
        [=]() -> HexPosition {
            HexPosition pos;
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::selectionPos, _win,
        [=]() -> HexPosition {
            HexPosition pos;
            memset(&pos, 0, sizeof(HexPosition));
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::currentRow, _win,
        [=]() -> qsizetype {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::currentColumn, _win,
        [=]() -> qsizetype {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::currentOffset, _win,
        [=]() -> qsizetype {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::selectedLength, _win,
        [=]() -> qsizetype {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::selectedBytes, _win,
        [=]() -> QByteArray {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::stringVisible, _win,
        [=]() -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::headerVisible, _win,
        [=]() -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::addressVisible, _win,
        [=]() -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::addressBase, _win,
        [=]() -> quintptr {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::atEnd, _win,
        [=]() -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::canUndo, _win,
        [=]() -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::canRedo, _win,
        [=]() -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::documentLastLine, _win,
        [=]() -> qsizetype {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::documentLastColumn, _win,
        [=]() -> qsizetype {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::copy, _win,
        [=](bool hex) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
    ...
    connect(
        preader, &WingPlugin::Reader::readInt8, _win,
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::readInt16, _win,
        [=](qsizetype offset) -> qint16 {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto buffer =
                    e->hexEditor()->document()->read(offset, sizeof(qint16));
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::readInt32, _win,
        [=](qsizetype offset) -> qint32 {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto buffer =
                    e->hexEditor()->document()->read(offset, sizeof(qint32));
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::readInt64, _win,
        [=](qsizetype offset) -> qint64 {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto buffer =
                    e->hexEditor()->document()->read(offset, sizeof(qint64));
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::readString, _win,
    ...
    connect(
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::searchForward, _win,
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::searchBackward, _win,
        [=](qsizetype begin, const QByteArray &ba) -> qsizetype {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                return e->hexEditor()->document()->searchBackward(begin, ba);
            }
            return qsizetype(-1);
        },
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::getMetaLine, _win,
        [=](qsizetype line) -> HexLineMetadata {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto ometas = e->hexEditor()->document()->metadata()->get(line);
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::getMetadatas, _win,
            ...
            if (e) {
                ...
                for (auto &item : ometaline) {
                    metaline.push_back(HexMetadataAbsoluteItem(
                        item.begin, item.end, item.foreground, item.background,
                        item.comment));
                }
                return metaline;
            }
    ...
    connect(
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::lineHasBookMark, _win,
        [=](qsizetype line) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::getsBookmarkPos, _win,
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::bookMark, _win,
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::bookMarkComment, _win,
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::getBookMarks, _win,
        [=]() -> QList<BookMark> {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::existBookMark, _win,
        [=](qsizetype pos) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::getOpenFiles, _win,
        [=]() -> QStringList { return _win->m_openedFileNames; },
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::getSupportedEncodings, _win,
        [=]() -> QStringList { return Utilities::getEncodings(); },
        Qt::DirectConnection);
    connect(
        preader, &WingPlugin::Reader::currentEncoding, _win,
        [=]() -> QString {
            auto e = pluginCurrentEditor(sender());
            if (e) {
...
void PluginSystem::connectControllerInterface(IWingPlugin *plg) {
    ...
    connect(
        pctl, &WingPlugin::Controller::switchDocument, _win,
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::setLockedFile, _win,
        [=](bool b) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::setKeepSize, _win,
        [=](bool b) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::setStringVisible, _win,
        [=](bool b) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::setHeaderVisible, _win,
        [=](bool b) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::setAddressVisible, _win,
        [=](bool b) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::setAddressBase, _win,
        [=](quintptr base) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::undo, _win,
        [=]() -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::redo, _win,
        [=]() -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::cut, _win,
        [=](bool hex) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                e->hexEditor()->cut(hex);
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::paste, _win,
        [=](bool hex) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
    ...
    connect(
        pctl, &WingPlugin::Controller::insertInt8, _win,
    ...
    connect(
        pctl, &WingPlugin::Controller::insertInt16, _win,
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::insertInt32, _win,
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::insertInt64, _win,
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::insertString, _win,
    ...
    connect(
        pctl, &WingPlugin::Controller::writeInt8, _win,
        [=](qsizetype offset, qint8 value) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
                auto buffer = reinterpret_cast<char *>(&value);
                return doc->replace(offset, QByteArray(buffer, sizeof(qint8)));
            }
            return false;
        },
        Qt::DirectConnection);
    ...
    connect(
        pctl, &WingPlugin::Controller::writeInt16, _win,
        [=](qsizetype offset, qint16 value) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
                auto buffer = reinterpret_cast<char *>(&value);
                return doc->replace(offset, QByteArray(buffer, sizeof(qint16)));
            }
            return false;
        },
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::writeInt32, _win,
        [=](qsizetype offset, qint32 value) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
                auto buffer = reinterpret_cast<char *>(&value);
                return doc->replace(offset, QByteArray(buffer, sizeof(qint32)));
            }
            return false;
        },
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::writeInt64, _win,
        [=](qsizetype offset, qint64 value) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
                auto buffer = reinterpret_cast<char *>(&value);
                return doc->replace(offset, QByteArray(buffer, sizeof(qint64)));
            }
            return false;
        },
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::writeString, _win,
        [=](qsizetype offset, const QString &value,
            const QString &encoding) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
    ...
    connect(
        pctl, QOverload<uchar>::of(&WingPlugin::Controller::append), _win,
        [=](uchar b) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
    ...
    connect(
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::appendInt8, _win,
        [=](qint8 value) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::appendInt16, _win,
        [=](qint16 value) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::appendInt32, _win,
        [=](qint32 value) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::appendInt64, _win,
        [=](qint64 value) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::appendString, _win,
    ...
    connect(
        pctl, &WingPlugin::Controller::remove, _win,
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::removeAll, _win,
        [=]() -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
    ...
    connect(
        ...
        Qt::DirectConnection);
    connect(
        pctl, QOverload<qsizetype>::of(&WingPlugin::Controller::moveTo), _win,
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::selectOffset, _win,
    ...
    connect(
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::enabledCursor, _win,
        [=](bool b) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::setInsertionMode, _win,
        [=](bool isinsert) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
    ...
    connect(
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::removeMetadata, _win,
        [=](qsizetype offset) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::clearMeta, _win,
        [=]() -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::color, _win,
        [=](qsizetype line, qsizetype start, qsizetype length,
    ...
    connect(
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::applyMetas, _win,
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::setMetaVisible, _win,
        [=](bool b) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::setMetafgVisible, _win,
        [=](bool b) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::setMetabgVisible, _win,
        [=](bool b) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::setMetaCommentVisible, _win,
        [=](bool b) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::setCurrentEncoding, _win,
        [=](const QString encoding) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
    ...
    connect(
        pctl, &WingPlugin::Controller::addBookMark, _win,
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::modBookMark, _win,
        [=](qsizetype pos, const QString comment) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::removeBookMark, _win,
        [=](qsizetype pos) -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
        ...
        Qt::DirectConnection);
    connect(
        pctl, &WingPlugin::Controller::clearBookMark, _win,
        [=]() -> bool {
            auto e = pluginCurrentEditor(sender());
            if (e) {
                auto doc = e->hexEditor()->document();
    ...
    // mainwindow
    connect(
        pctl, &WingPlugin::Controller::newFile, _win,
        [=]() -> bool {
            QObject *s = sender();
            if (checkSender(s)) {
    ...
    connect(
        ...
        Qt::BlockingQueuedConnection);
    connect(
        pctl, &WingPlugin::Controller::closeFile, _win,
        ...
        Qt::BlockingQueuedConnection);
    connect(
        pctl, &WingPlugin::Controller::saveFile, _win,
    ...
    connect(pctl, &WingPlugin::Controller::exportFileGUI, _win,
            &MainWindow::on_exportfile, Qt::BlockingQueuedConnection);
    ...
    connect(pctl, &WingPlugin::Controller::saveasFileGUI, _win,
            &MainWindow::on_saveas, Qt::BlockingQueuedConnection);

    connect(
        pctl, &WingPlugin::Controller::closeCurrentFile, _win,
        [=](bool force) -> ErrFile {
        ...
        Qt::BlockingQueuedConnection);
    connect(
        pctl, &WingPlugin::Controller::saveCurrentFile, _win,
        [=](bool ignoreMd5) -> ErrFile {
